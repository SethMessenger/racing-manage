...
import com.wxmp.core.util.XmlHelper;
...
public class WxPayUtils {
    ...
    public static Map<String, String> buildSignAfterParasMap(Map<String, String> params, String paternerKey) {
        ...
        String sign = WxPayUtils.createSign(params, paternerKey);
    ...
    public static boolean verifyNotify(Map<String, String> params, String paternerKey) {
        ...
        String localSign = WxPayUtils.createSign(params, paternerKey);
    ...
    public static Map<String, String> prepayIdCreateSign(String prepay_id) {
        ...
        String packageSign = WxPayUtils.createSign(packageParams, WxPayApiConfigKit.getWxPayApiConfig().getPaternerKey());
