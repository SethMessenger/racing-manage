...
public class WxPayApi {
    ...
    public static String getsignkey(String mch_id,String partnerKey){
        ...
        map.put("sign", WxPayUtils.createSign(map, partnerKey));
    ...
    public static String getCodeUrl(String appid, String mch_id, String product_id, String partnerKey, boolean isToShortUrl){
        ...
        String packageSign = WxPayUtils.createSign(packageParams, partnerKey);
        String qrCodeUrl=WxPayUtils.replace(url, "XXXXX", packageSign,appid,mch_id,product_id,timeStamp,nonceStr);
        if (isToShortUrl) {
            String shortResult = WxPayApi.toShortUrl(WxPayUtils.buildShortUrlParasMap(appid, null, mch_id, null, qrCodeUrl, partnerKey));
            Map<String, String> shortMap = WxPayUtils.xmlToMap(shortResult);
    ...
    public static String doPost(String url, Map<String, String> params){
        return HttpUtil.doPost(url, WxPayUtils.toXml(params));
    }

    public static String doPostSSL(String url, Map<String, String> params, String certPath, String certPass ){
//        return HttpUtil.postSSL(url, WxPayUtils.toXml(params), certPath, certPass);
        return null;
    }
}
